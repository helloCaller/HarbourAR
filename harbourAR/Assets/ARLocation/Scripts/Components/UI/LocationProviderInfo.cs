...
namespace ARLocation.UI
{
    ...
    public float destinationLatitude = 3.642814f;
    public float destinationLongitude = -79.399473f;
    ...
    void Start()
        {
            ...
            texts.Add(GameObject.Find(gameObject.name + "/Panel/Canvas/distance").GetComponent<Text>());
      ...
      float latitude = Convert.ToSingle(locationProvider.CurrentLocation.latitude);
      float longitude = Convert.ToSingle(locationProvider.CurrentLocation.longitude);
      

      float currentDistance = currentDistanceToDestination(latitude,longitude, destinationLatitude, destinationLongitude);
      print(currentDistance);
      texts[9].text = "Distance: " + currentDistance;
        }
