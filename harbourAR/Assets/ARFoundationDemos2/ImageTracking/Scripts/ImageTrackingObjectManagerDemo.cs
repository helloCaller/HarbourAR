...
public class ImageTrackingObjectManagerDemo : MonoBehaviour
{
    [SerializeField]
    ...
    void ImageManagerOnTrackedImagesChanged(ARTrackedImagesChangedEventArgs obj)
    {
        ...
        foreach(ARTrackedImage image in obj.updated)
        {
            ...
            else
            {
                if (image.referenceImage.guid == s_FirstImageGUID)
                {
                    m_OneNumberManager.EnableARVideo(false);
                }
                else if (image.referenceImage.guid == s_SecondImageGUID)
                {
                    m_TwoNumberManager.EnableARVideo(false);
                }
            }
        }
